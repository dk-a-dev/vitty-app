...
class AuthViewModel : ViewModel() {
    ...
    fun signInAndGetTimeTable(
        username: String,
        regno: String,
        uuid: String,
        campus: String,
    ) {
        APICommunityRestClient.instance.signInWithUsernameRegNo(
            username,
            regno,
            uuid,
            campus,
            object : RetrofitCommunitySignInListener {
                override fun onSuccess(
                    ...
                    Timber.d("username: $username regno: $regno uuid: $uuid campus: $campus")
    ...
    fun checkUsername(username: String) {
        APICommunityRestClient.instance.checkUsername(
            username,
